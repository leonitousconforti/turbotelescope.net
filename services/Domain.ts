    ...
    ),
    {
        encode: (shortName) =>
            Function.pipe(
                ...
                Match.when("Filter", () => "filter image by the shape of sources" as const),
                ...
                Match.when("Fltr CTS", () => "Filter out candidates close to stars " as const),
        ...
        decode: (longName) =>
            Function.pipe(
                ...
                Match.when("filter image by the shape of sources", () => "Filter" as const),
                Match.when("Assign Reference", () => "Assign Reference" as const),
                Match.whenOr(
                    "Align ref to sci and propagate wcs from ref to sci",
                    "Align ref to sci and propogate wcs from ref to sci",
                ...
                Match.when("Filter out candidates close to stars ", () => "Fltr CTS" as const),
